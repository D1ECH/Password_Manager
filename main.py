...
parser = argparse.ArgumentParser(description="python3 main.py [operacion a realizar --> -a / -e / -g]")

parser.add_argument('option', help='(a)dd / (e)xtract / (g)enerate')
parser.add_argument("-a","--add", help="Añadir datos sobre una nueva cuenta.")
parser.add_argument("-e", "--extract", help="Extraer información en función de unos datos proporcionados.")
parser.add_argument("-g", "--generate", help="Generador de contraseña.")
